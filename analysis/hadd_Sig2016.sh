...
python haddnano.py Taustar_m2500_2016.root `xrdfsls -u | grep \.root`
xrdcp -f Taustar_m2500_2016.root ${OUTPUTDIR}

python haddnano.py Taustar_m3000_2016.root `xrdfsls -u | grep \.root`
xrdcp -f Taustar_m3000_2016.root ${OUTPUTDIR}

python haddnano.py Taustar_m3500_2016.root `xrdfsls -u | grep \.root`
xrdcp -f Taustar_m3500_2016.root ${OUTPUTDIR}

python haddnano.py Taustar_m4000_2016.root `xrdfsls -u | grep \.root`
xrdcp -f Taustar_m4000_2016.root ${OUTPUTDIR}

python haddnano.py Taustar_m4500_2016.root `xrdfsls -u | grep \.root`
xrdcp -f Taustar_m4500_2016.root ${OUTPUTDIR}

python haddnano.py Taustar_m5000_2016.root `xrdfsls -u | grep \.root`
xrdcp -f Taustar_m5000_2016.root ${OUTPUTDIR}
