...
python haddnano.py WW_2017.root `xrdfsls -u | grep \.root`
xrdcp -f WW_2017.root ${OUTPUTDIR}
rm WW_2017.root

python haddnano.py WZ_2017.root `xrdfsls -u | grep \.root`
...
python haddnano.py ST_tW_antitop_2017.root `xrdfsls -u | grep \.root`
xrdcp -f ST_tW_antitop_2017.root ${OUTPUTDIR}
rm ST_tW_antitop_2017.root

python haddnano.py ST_tW_top_2017.root `xrdfsls -u | grep \.root`
xrdcp -f ST_tW_top_2017.root ${OUTPUTDIR}
rm ST_tW_top_2017.root

python haddnano.py ST_t_channel_top_2017.root `xrdfsls -u | grep \.root`
xrdcp -f ST_t_channel_top_2017.root ${OUTPUTDIR}
rm ST_t_channel_top_2017.root

python haddnano.py ST_t_channel_antitop_2017.root `xrdfsls -u | grep \.root`
...
rm Taustar_m250_2017.root

python haddnano.py Taustar_m625_2017.root `xrdfsls -u | grep \.root`
xrdcp -f Taustar_m625_2017.root ${OUTPUTDIR}
rm Taustar_m625_2017.root

python haddnano.py TTTo2L2Nu_2017.root `xrdfsls -u | grep \.root`
xrdcp -f TTTo2L2Nu_2017.root ${OUTPUTDIR}
rm TTTo2L2Nu_2017.root

python haddnano.py TTToSemiLeptonic_2017.root `xrdfsls -u | grep \.root` 
