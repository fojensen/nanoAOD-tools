...
cut_TauTau = "Sum$(Tau_pt>=20. && TMath::Abs(Tau_eta)<2.3 && Tau_decayMode!=5 && Tau_decayMode!=6)>=2"
cut_ETau = "Sum$(TMath::Abs(Electron_eta)<2.5)>0 && Sum$(Tau_pt>=20. && TMath::Abs(Tau_eta)<2.3 && Tau_decayMode!=5 && Tau_decayMode!=6)>0"
cut_MuTau = "Sum$(TMath::Abs(Muon_eta)<2.4)>0 && Sum$(Tau_pt>=20. && TMath::Abs(Tau_eta)<2.3 && Tau_decayMode!=5 && Tau_decayMode!=6)>0"
...
cut_ = "("+ cut_MuTau + " || " + cut_ETau + " || " + cut_TauTau + ") && " + cut_Flag
print cut_
