...
cut_ = "("+ cut_MuoMuo + " || " + cut_EleTau + " || " + cut_MuoTau + " || " + cut_TauTau + " || " + cut_Tau + " || " + cut_TauMET + ") && " + cut_Flag
#print cut_
...
modules_ = [EEProducerConstr(), MuMuProducerConstr(), MuTauProducerConstr(), ElTauProducerConstr(), TauTauProducerConstr(), JetProducerConstr()]
