...
cut_Tau = "(Sum$(Tau_pt>=20. && TMath::Abs(Tau_eta)<2.3 && (1&Tau_idDeepTau2017v2p1VSjet) && (8&Tau_idDeepTau2017v2p1VSmu) && (4&Tau_idDeepTau2017v2p1VSe))>0)"
...
from PhysicsTools.NanoAODTools.postprocessing.examples.abcdRegion import abcdRegionConstr
modules_ = [MuTauGammaProducerConstr(isMC, isEmb, year), MuMuGammaProducerConstr(), JetProducerConstr(), abcdRegionConstr()]
#modules_ = [MuTauGammaProducerConstr(isMC, isEmb, year), JetProducerConstr(), abcdRegionConstr()]
if isEmb:
